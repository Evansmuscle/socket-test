...
var generateCodeController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, generateCode_model_1.GeneratedCodeModel.deleteMany()];
            case 1:
                _a.sent();
                code = (0, generateCode_helper_1.default)();
                codeDoc = new generateCode_model_1.GeneratedCodeModel({
                    code: code,
                });
